            ...
            <div class="job-info">
                <ApolloQuery :query="require('@/graphql/queries/JobInfoQry.gql')" :variables="{ id: jobId }">
                    <template slot-scope="{ result: { loading, error, data } }">
                        ...
                        <!-- Result -->
                        <div v-else-if="data && data.jobs_by_pk">
                        ...
                        <div v-else class="job-info-container rounded p-5 m-5">No job selected</div>
                    </template>
                </ApolloQuery>
            </div>
        </div>
...
<script>
import JOBSEARCHQRY from '~/graphql/queries/JobSearchQry.gql'
export default {
